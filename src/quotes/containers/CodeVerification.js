    ...
    return (
      <div>
        <div className="d-flex justify-content-between">
          <Link to="/quotes/phone-verification/" href="/quotes/phone-verification/" className="quote_back-btn">
        ...
        <Row>
          ...
          >
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <Button className="confirm-btn btn-lg btn-block mt-4">Continue Trading</Button>
            </Form>
            <Link
