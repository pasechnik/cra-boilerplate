      ...
      return (
        <Modal isOpen={modal} backdrop="static" className="quote-modal" autoFocus={false}>
          <ModalBody>
            ...
            <Modal isOpen={nestedModal} toggle={this.toggleNested} className="trader_nested-modal">
              <ModalHeader>
          ...
          <ModalFooter>
            <div>
              ...
              <Button className="trader_nested-modal-link" onClick={this.toggleNested} onKeyPress={this.toggleNested}>
                here
              </Button>
            </div>
          </ModalFooter>
