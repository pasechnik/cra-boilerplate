...
const APPCONFIG = {
  ...
  newDepositURL:
    ENV === 'production' ? '/mzc.php?action=mz_cashier_deposit' : 'http://localhost:4060/v1/mzc/mz_cashier_deposit',
  ...
  generalSettingsFront:
    ENV === 'production'
      ...
      : 'http://localhost:4060/v1/mzc/mz_cashier_get_general_settings_front/?_dc=1536524325635',
  fetchNewAccount:
  ...
  fetchCountriesURL:
    ENV === 'production' || ENV === 'development'
      ...
      : 'http://localhost:4060/v1/mzc/mz_cashier_get_countries',
  fetchPagoCountriesURL:
    ENV === 'production' || ENV === 'development'
      ? '/mzc.php?action=mz_cashier_get_pago_countries'
      : 'http://localhost:4060/v1/mzc/mz_cashier_get_pago_countries',
  fetchExistingCardsURL:
    ENV === 'production' || ENV === 'development'
      ? '/mzc.php?action=mz_cashier_get_existing_cards'
      : 'http://localhost:4060/v1/mzc/mz_cashier_get_existing_cards',
  getNewAddressUrl:
    ENV === 'production' || ENV === 'development'
