const initial = {
  ...
  lang: {
    ...
    mz_cashier_force_new_cc: 'Dear Customer,As an additional security level, your transaction will be processed using 3D secure measure. Please complete as described in the following page',
    ...
    mz_cashier_not_valid_credit_card: 'This is not a valid Credit Card.  Please check your CARD TYPE and NUMBER and try again.',
    ...
    mz_cashier_footer_disclaimer: 'Payments are being processed by Titan Trade<br>Phone: +44 2036088333<br><br>Some credit cards require 3D verification.<br>In such case, contact your bank for receving the verification code',
    mz_cashier_ok: 'OK',
    ...
    mz_cashier_wire_details_description: 'Please deposit to the following bank account details.<br>Once funds are received, it will be credited to your trading account.',
    ...
    mz_cashier_popup_accountType_body: 'Deposit {amount}{currency} or more and one of our representatives will contact you to grand you your benefits',
